...
#import "XibReuseViewController.h"
#import "XibReuseView.h"
#import "XibReuseTableViewCell.h"
#import "CommonTools.h"


@interface XibReuseViewController ()
@property (nonatomic, strong)  XibReuseView *imageDownloadView;
...
@implementation XibReuseViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.imageDownloadView = [[XibReuseView alloc] initWithFrame:self.view.frame andDelegate:self];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //是否为nil
    XibReuseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier forIndexPath:indexPath];
...
- (void)downloadImageWithUrl:(NSString *)url forTableViewCell:(XibReuseTableViewCell*)cell andIndex:(NSInteger)item {
    XibReuseTableViewCell *downloadCell = cell;
